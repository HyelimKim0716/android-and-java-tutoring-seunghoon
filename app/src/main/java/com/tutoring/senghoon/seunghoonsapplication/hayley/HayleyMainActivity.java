    ...
    private View.OnClickListener mBtnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.hayleyMain_btnKakao:
                    intent = new Intent(HayleyMainActivity.this, HayleyKakaoCharacterActivity.class);
                    break;

                case R.id.hayleyMain_btnPlayer:
                    intent = new Intent(HayleyMainActivity.this, HayleyPlayerInterfaceActivity.class);
                    break;
