...
public class SeunghoonDogClassActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvBreed1 = findViewById(R.id.sh_dogClass_tvBreed1);
        tvSize1 = findViewById(R.id.sh_dogClass_tvSize1);
        tvAge1 = findViewById(R.id.sh_dogClass_tvAge1);
        tvColor1 = findViewById(R.id.sh_dogClass_tvColor1);

        tvBreed2 = findViewById(R.id.sh_dogClass_tvBreed2);
        tvSize2 = findViewById(R.id.sh_dogClass_tvSize2);
        tvAge2 = findViewById(R.id.sh_dogClass_tvAge2);
        tvColor2 = findViewById(R.id.sh_dogClass_tvColor2);

        tvBreed3 = findViewById(R.id.sh_dogClass_tvBreed3);
        tvSize3 = findViewById(R.id.sh_dogClass_tvSize3);
        tvAge3 = findViewById(R.id.sh_dogClass_tvAge3);
        tvColor3 = findViewById(R.id.sh_dogClass_tvColor3);

        Dog seunghoonDog = new Dog("비숑","Medium",2, "White");
       Dog teacherDog = new Dog("포메라니안","Small",4,"Brown");
       Dog mingyuDog = new Dog("치와와","Big",6,"Black");
